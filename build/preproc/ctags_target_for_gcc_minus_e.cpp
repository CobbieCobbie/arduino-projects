# 1 "c:\\Users\\Cobbie\\git\\arduino-projects\\PixelLED\\PixelLED.ino"
# 2 "c:\\Users\\Cobbie\\git\\arduino-projects\\PixelLED\\PixelLED.ino" 2




Adafruit_NeoPixel pixels(8, 6, ((1 << 6) | (1 << 4) | (0 << 2) | (2)) /*|< Transmit as G,R,B*/ + 0x0000 /*|< 800 KHz data transmission*/);
...
void loop() {
  ...
  color = pixels.Color(0,((reg_val_map)>0?(reg_val_map):-(reg_val_map)),((reg_val_map)>0?(reg_val_map):-(reg_val_map)));
...
# 81 "c:\\Users\\Cobbie\\git\\arduino-projects\\PixelLED\\PixelLED.ino"
}
